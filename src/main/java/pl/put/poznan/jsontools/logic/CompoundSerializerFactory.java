...
public class CompoundSerializerFactory {
   ...
   *
   * <p>The key is built as follows: operation1:param1,param2;operation2:param1,param2
   *
  ...
  String[] parseInput(String transformsKey) {
    if ("".equals(transformsKey)) return new String[] {};
   ...
   */
  JsonSerializer createSerializer(TransformDesignator td, JsonSerializer innerSerializer)
    ...
    throw new InvalidParameterException(
        td.transformId + " is not a valid key for a compound JSON serializer.");
  }
